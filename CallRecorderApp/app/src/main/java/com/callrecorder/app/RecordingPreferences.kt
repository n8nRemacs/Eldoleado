...
/**
 * Manages recording preferences and settings
 */
class RecordingPreferences(context: Context) {
    ...
    companion object {
        ...
        // Default server URL - change this to your actual server
        private const val DEFAULT_SERVER_URL = "https://your-server.com/api/upload"
    }
